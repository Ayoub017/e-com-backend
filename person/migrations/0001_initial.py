# Generated by Django 3.2.8 on 2022-01-14 04:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lat_pos', models.FloatField(default=0)),
                ('long_pos', models.FloatField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cuisinier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cuisinier', to=settings.AUTH_USER_MODEL)),
                ('product', models.ManyToManyField(to='person.Product')),
            ],
        ),
    ]
